...
export async function RecoverPasswordValidator(req, res) {
    ...
    try {
        ...
        return new ApiResponse(200, 'Se ha enviado un email con las instrucciones');
    }
    catch (error) {
        return new InternalServerException(error.message);
    }
}
export async function RecoverPasswordTokenValidator(req) {
    ...
    if (tokenValido) {
        ...
        return new ApiResponse(200, 'Token válido');
    }
    else {
...
export async function SetNewPasswordValidator(req) {
